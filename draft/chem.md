...
<div id="chem-sketcher-page">
    ...
    <div id="custom-toolbar">
        <button onclick="selectTool('select')">选择工具</button>
        <button onclick="selectTool('bond')">键工具</button>
        <button onclick="selectTool('atom')">原子工具</button>
        <button onclick="undo()">撤销</button>
        <button onclick="redo()">重做</button>
        <button onclick="clearSketch()">清除</button>
    </div>
</div>
