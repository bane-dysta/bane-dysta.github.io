...
- [输出](#输出)
  ...
  - [int_lowfreq.dat](#int_lowfreqdat)
- [绘图与整理](#绘图与整理)
- [常见问题](#常见问题)
...
这个文件只统计低频范围内的贡献，并把低频范围内的内坐标贡献按从大到小排序。注意两个文件使用的低频阈值写法不同。lambda.dat 的 Summary 使用小于 200 cm-1。int\_lowfreq.dat 使用小于等于 208.5 cm-1。它们分别对应模式层面的低频统计与低频范围内的内坐标排序。
