...
![](https://pub-ec46b9a843f44891acf04d27fddf97e0.r2.dev/2025/12/20251208171037.png)

对于一个懒狗来说，只要有一丝偷懒的可能，手动改那当然是不可能的。在Preferences界面瞎点了几下，笔者注意到了样式编辑器的功能：

![](https://pub-ec46b9a843f44891acf04d27fddf97e0.r2.dev/2025/12/20251208171229.png)

虽然笔者看不懂xml，但是这段代码令笔者明白肯定有个地方指向DOI，只要把那个玩意删掉就行。把csl文件丢给Claude，果然发现了类似的地方:
```
<macro name="access">
    <choose>
...
```
只要移除这一段，就可以令zotero插入引文时不自动添加doi号了。

[Zotero-AnalChem-nodoi.csl](https://pub-ec46b9a843f44891acf04d27fddf97e0.r2.dev/2025/12/analytical-chemistry-no-doi.csl)
