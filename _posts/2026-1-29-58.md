...
{% capture mol_text %}{% include_relative mols/58/model.mol %}{% endcapture %}
{% include xyz.html mode="3d" mol=mol_text 
width=500 height=350 representation="Ball and Stick" bgcolor="white" 
atom_diameter_3d=8.0 bond_diameter_3d=1.5 %}
