...
本文于June 25, 2026被发表于JCTC的[GPU Accelerated Minimal Auxiliary Basis Approach TDDFT for Large Organic Molecules](https://doi.org/10.1021/acs.jctc.6c00629)一文引用，感谢周泽浩老师！周老师的TDDFT-ris是一个非常优秀的大体系激发态算法，可以利用GPU加速做到10万原子的TDDFT计算，且可以进行波函数分析。很厉害的工作，读者若有兴趣可以了解一下。
