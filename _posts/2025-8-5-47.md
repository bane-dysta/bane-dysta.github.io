...
tags: [Excited State, Wavefunction Analysis, Large System, NTO, Multiwfn]
asset_id: 47
chem: true
---

本文于June 25, 2026被发表于JCTC的[GPU Accelerated Minimal Auxiliary Basis Approach TDDFT for Large Organic Molecules](https://doi.org/10.1021/acs.jctc.6c00629)一文引用，感谢周泽浩老师！周老师的TDDFT-ris是一个非常优秀的大体系激发态算法，可以利用GPU加速做到10万原子的TDDFT计算，且可以进行波函数分析，是很厉害的工作，读者若有兴趣可以了解一下。

对于巨型体系，如COF，直接TD-DFT计算激发态将非常困难。此时就需要一些简化算法，以便将资源消耗控制在可以接受的资范围内。本文打算记录一些非常规的方案，取的例子是：
{% include xyz.html 
   mode="2d" 
   src="assets/posts/47/model.mol"  
   mol=mol_text 
