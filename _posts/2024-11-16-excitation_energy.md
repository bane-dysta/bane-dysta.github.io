...
> **但2ζ基组与3ζ基组之间的差距仍然非常显著，如2ζ基组结果不理想，提升至3ζ是值得尝试的。**在笔者经手的体系里，很大一部分使用def2-SVP与def2-TZVP的差距显著，少部分体系激发能甚至能错1个电子伏特！(某例: 泛函同为cam-B3LYP。def2-tzvp: 534 nm; def2-svp: 971 nm)
{: .prompt-info }
