...
- 由于电荷转移，初态与末态波函数的重叠程度减小了，跃迁偶极矩减小，由$(2.1)$ - $(2.3)$式可知这会引起振子强度的减小，对荧光产生削弱作用。从另一方面来讲，跃迁偶极矩减小也会引起两个态的混合程度降低，减小NAC矩阵元，由$(5.0.1)$式知内转换速率也会减小，对荧光产生增强作用。根据经验，电荷转移对辐射跃迁速率的影响更大，因此**常常表现为削弱荧光强度**。
