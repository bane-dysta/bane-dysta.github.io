...
```
## 玩具测试
笔者很早就想用RDkit的功能做个smiles转3D，之前有python脚本，打包之后600多M吓哭了，现在有MSVC，就可以极大地削减体积了。脚本太长，读者若有兴趣可自行[下载](\_file\64\main.cpp)。在CMakeLists中，需要把刚才安装的RDkit库添加到CMAKE_PREFIX_PATH使得新项目能找到RDkit库。
```cmake
